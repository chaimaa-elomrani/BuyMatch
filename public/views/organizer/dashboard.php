...
<head>
    ...
    <title>Tableau de bord Organisateur - BuyMatch</title>
    <style>
...
<body>
    <div class="container">
        <h1>Espace Organisateur - <?= htmlspecialchars($organizer->getFullname()) ?></h1>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                <h3><?= htmlspecialchars(number_format($stats['note_moyenne'] ?? 0, 1)) ?></h3>
                <p>Note moyenne</p>
            </div>
        </div>
        ...
        <?php if (empty($matches)): ?>
            <p>Aucun match créé. <a href="?route=organizer&action=createMatch">Créer votre premier match</a></p>
        <?php else: ?>
            <table>
                <thead>
                    <tr>
